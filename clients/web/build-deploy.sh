...
export REACT_APP_MAPBOX="" # place MAPBOX private key here
...
yarn build
# serve -s build # start local web server to run 
...
# ------------------------------------------------------------------------------
# go clean
# docker push us.gcr.io/alnw-elevate/go-webclient:$version
# docker rmi us.gcr.io/airliftnw-uw/go-webclient:$version
